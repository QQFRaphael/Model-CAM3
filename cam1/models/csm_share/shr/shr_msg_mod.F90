!===============================================================================
! CVS $Id: shr_msg_mod.F90,v 1.2.4.2 2005/01/20 23:16:16 mvr Exp $
   ...
   if (.not. exists) then
      ...
      if (rcode > 0) then
         ...
         if (stdout /= "nochange") then
            ...
            write(6,F00) "write ",trim(filename),', unit 6 connected to ',trim(stdout)
         else
            write(6,F00) "write ",trim(filename),', unit 6 has *not* been redirected'
         endif
