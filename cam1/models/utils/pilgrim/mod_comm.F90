...
#if defined(USE_MPI2) && (!defined AIX) && (!defined LINUX) && (!defined OSF1) && (!defined UNICOSMP)
...
! !LOCAL VARIABLES:
      ...
      integer nwin, nwinhit, ns, i, j, qsiz, send_tag, recv_tag
      logical locwin
...
! temporary contiguous buffers
      ...
      do ipe=1, numpro
         ...
         if (r8_win%size_r .ne. 0) then
            ...
            r8_win%src = ipe-1
!    Inlining:       call Ga_RecvInit_r8(r8_win, ga_r8_r)
