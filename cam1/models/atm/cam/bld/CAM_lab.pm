...
#
#	$Id: CAM_lab.pm,v 1.15.6.16 2004/04/28 23:43:44 eaton Exp $
#
use strict;
#use diagnostics;
...
#
  ...
  $CASE_DIR_ornl{'aix'} = "/tmp/gpfs750a/$LOGNAME";
  $CASE_DIR_ornl{'unicosmp'} = "/scratch/scr600b/$LOGNAME";
  $CASE_DIR_ornl{'default'} = "/tmp/gpfs750a/$LOGNAME";
...
#
  ...
  $SMP_ornl{'unicosmp'} = "FALSE";
  $SMP_ornl{'default'} = "TRUE";
...
#
  ...
  $LIB_NETCDF_ornl{'unicosmp'} = "/apps/netcdf/prod/x1_r8/lib";
...
#
  ...
  $INC_NETCDF_ornl{'unicosmp'} = "/apps/netcdf/prod/x1_r8/include";
  $INC_NETCDF_ornl{'default'} = "/usr/local/include";
