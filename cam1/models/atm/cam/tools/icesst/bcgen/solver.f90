...
CONTAINS
   ...
   integer, parameter :: nmont = 12*130
   ...
   real(r8) :: r(nmont), avg(nmont), aa(nmont), bb(nmont), cc(nmont), add(nmont)
...
! ???  check following value
   ...
   if (nmon > nmont) then
      write(6,*) 'error-- nmont not declared large enough in '
