...
!!$   call outfld('TVADV'   ,tvadv,plon,dummy)
!!$   call outfld('QVADV'   ,qvadv,plon,dummy)
!
...
!!$         end do
!!$!
!!$         call outfld('TRELAX',relaxt,plon,dummy )
!!$         call outfld('QRELAX',relaxq,plon,dummy )
...
!
   call outfld('TOBS',tobs,plon,dummy)
   call outfld('QOBS',qobs,plon,dummy)
   call outfld('TDIFF',tdiff,plon,dummy)
   call outfld('QDIFF',qdiff,plon,dummy)
   if( use_iop ) then
      call outfld('DIVQ',divq,plon,dummy)
      call outfld('DIVT',divt,plon,dummy)
      call outfld('DIVQ3D',divq3d,plon,dummy)
      call outfld('DIVT3D',divt3d,plon,dummy)
!!$      call outfld('DIVU',divu,plon,dummy)
!!$      call outfld('DIVV',divv,plon,dummy)
      call outfld('PRECOBS',precobs,plon,dummy )
      call outfld('LHFLXOBS',lhflxobs,plon,dummy )
      call outfld('SHFLXOBS',shflxobs,plon,dummy )
!!$      call outfld('Q1OBS',q1obs,plon,dummy )
!!$      call outfld('Q2OBS',q2obs,plon,dummy )
   endif
