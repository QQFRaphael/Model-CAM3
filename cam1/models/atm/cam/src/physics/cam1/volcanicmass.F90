...
!-----------------------------------------------------------------------
  ...
  use pmgrid,       only: plat, plon, masterproc, plev, plevp
...
!
  allocate (volc3D(plon,levsiz,plat))
...
!
    ...
    call scatter_field_to_chunk(1,levsiz,1,plon,volc3D,volcanic(nprev)%mass)
...
!
    ...
    call scatter_field_to_chunk(1,levsiz,1,plon,volc3D,volcanic(nnext)%mass)
