...
! local variables
   ...
   integer :: naerlon
   integer :: nlon_aer(plat)            ! number of lons per lat on bdy dataset
   integer :: naerlat
   integer :: naerlev
...
!
      if (fullgrid) then
         ...
         if (ret == NF_NOERR) then
            call wrap_get_var_int (aernid, nlonid, nlon_aer)
            do j=1,plat
               if (nlon_aer(j) /= plon) then
                  call endrun ('AEROSOL_INITIALIZE: model grid does not match dataset grid')
               end if
            end do
         end if
      else
         call wrap_inq_varid (aernid, 'nlon', nlonid)
         call wrap_get_var_int (aernid, nlonid, nlon_aer)
         do j=1,plat
...
!
   ...
   real(r8), intent(in) :: pint(pcols,pverp)    ! Interface pressure (mks)
!
! Output arguments
!
   real(r8), intent(out) :: mmr(pcols,pver)     ! "background" aerosol mass mixing ratio
!
!---------------------------Local variables-----------------------------
!
...
!
   do i=1,ncol
      mass2mmr =  gravit / (pint(i,pverp)-pint(i,pverp-mxaerl))
      do k=1,pver
!
...
!-------------------------------------------------------------
  ...
  call addfld ('PS_match','N/m^2   ',1, 'I','Surface Pressure from aerosol climatology' ,phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('frc_day ','None    ',1, 'I','Portion of time column is lit' ,phys_decomp, sampling_seq='rad_lwsw')

  call addfld ('MSUL_V  ','Kg/m^2  ',pver,'I','Mass of Sulfate in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MSSLT_V ','Kg/m^2  ',pver,'I','Mass of Sea Salt in and below layer',phys_decomp)
  call addfld ('MDUST1_V','Kg/m^2  ',pver,'I','Mass of Dust bin 1 in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MDUST2_V','Kg/m^2  ',pver,'I','Mass of Dust bin 2 in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MDUST3_V','Kg/m^2  ',pver,'I','Mass of Dust bin 3 in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MDUST4_V','Kg/m^2  ',pver,'I','Mass of Dust bin 4 in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MOCPHO_V','Kg/m^2  ',pver,'I','Mass of OCPHO in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MOCPHI_V','Kg/m^2  ',pver,'I','Mass of OCPHI in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MBCPHO_V','Kg/m^2  ',pver,'I','Mass of BCPHO in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('MBCPHI_V','Kg/m^2  ',pver,'I','Mass of BCPHI in and below layer',phys_decomp, sampling_seq='rad_lwsw')
  ...
  call addfld ('SULOD_v ','None    ',1, 'I','Sulfate Optical Depth in visible', phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('SSLTOD_v','None    ',1, 'I','Sea Salt Optical Depth in visible', phys_decomp)
  call addfld ('CAROD_v ','None    ',1, 'I','Carbon Optical Depth in visible', phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('DUSTOD_v','None    ',1, 'I','Dust Optical Depth in visible', phys_decomp, sampling_seq='rad_lwsw')
  ...
  call addfld ('AEROD_v ','None    ',1, 'I','Total Aerosol Optical Depth in visible', phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('AERSSA_v','None    ',1, 'I','Total Aerosol Single Scattering Albedo in visible', phys_decomp, &
                                                                                   sampling_seq='rad_lwsw')
  call addfld ('AERASM_v','None    ',1, 'I','Total Aerosol Asymmetry Parameter in visible', phys_decomp, sampling_seq='rad_lwsw')
  call addfld ('AERFWD_v','None    ',1, 'I','Total Aerosol Forward Scattering in visible', phys_decomp, sampling_seq='rad_lwsw')
