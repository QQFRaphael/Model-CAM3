...
! relative humidity depression must be > 0 for evaporation
          evplimit = max(1. - q(i,k)/qsat(i,k), 0._r8)
...
!
   ...
   real(r8), intent(in), optional :: dpdry(pcols,pver)       ! Delta pressure between interfaces
