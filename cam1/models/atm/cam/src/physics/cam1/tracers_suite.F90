...
!  write(6,*)'TR SMOOTH indx hypm(indx)',indx,hypm(indx)
!  write(6,67)'TR SMOOTH ','k','hypm(k)','pdist','-a*(pd^2)','e^-a*(pd^2)'
...
!     write(6,66)'TR SMOOTH ',k,hypm(k),pdist,-alpha*pdist**2,q(1,k,1)
  end do
