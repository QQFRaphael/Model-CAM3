...
!   interface with cpl6.
!
! CVS Id: $Id: ccsm_msg.F90,v 1.11.2.21 2005/02/06 19:39:42 rosinski Exp $
! 
!-----------------------------------------------------------------------

#if (defined COUP_CSM)
  use shr_kind_mod, only: r8 => shr_kind_r8             ! atmospheric model precision
  use pmgrid, only: plat, plon, beglat, endlat, masterproc, iam      ! Model grid
# if (defined FV_BLOCK)
...
!-----------------------------------------------------------------------
    write(6,*)'(CCSM_MSG_COMPAT): This is revision: $Revision: 1.11.2.21 $'
    write(6,*)'              Tag: $Name: cam3_1_brnchT_p2 $'
