...
!-----------------------------------------------------------------------
!
! $Id: omcalc.F90,v 1.1.2.2 2004/09/23 17:20:09 erik Exp $
! $Author: erik $
!
!-----------------------------------------------------------------------
...
!---------------------------Local workspace-----------------------------
  ...
  real(r8) hkk(plon)        ! diagonal element of hydrostatic matrix
  real(r8) hlk(plon)        ! super diagonal element
  real(r8) suml(plon)       ! partial sum over l = (1, k-1)
