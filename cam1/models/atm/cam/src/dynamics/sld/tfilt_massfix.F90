...
!
  ...
  real(r8), intent(inout)   :: q3   (plon,plev,pcnst+pnats)! q + consts (time level n, after physics)
  real(r8), intent(inout):: q3m1    (plon,plev,pcnst+pnats)! q + consts (time level n+1)
  ...
  real(r8), intent(inout):: qm1   (plon,plev,pcnst+pnats)  ! q + consts input:   time level n, saved from last timestep;
